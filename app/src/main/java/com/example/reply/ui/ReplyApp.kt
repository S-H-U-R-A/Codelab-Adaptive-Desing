...
fun ReplyApp(
    ...
    val viewModel: ReplyViewModel = viewModel() //ViewModel de la app

    val replyUiState = viewModel.uiState.collectAsState().value //Estado de la app a partir del Flujo
    ...
    ReplyHomeScreen(
        ...
        onTabPressed = { mailboxType: MailboxType ->
            viewModel.updateCurrentMailbox(mailboxType = mailboxType)//Actualiza la pantalla en la cual estoy
            viewModel.resetHomeScreenStates() //Resetea la pantalla
        },
